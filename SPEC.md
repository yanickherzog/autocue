...
- CI (`.github/workflows/ci.yml`) exists as of `ROADMAP.md` D1, but its pinned Xcode version for GitHub-hosted runners hasn't been confirmed against a live runner — see `docs/REVIEW.md`'s entry for this batch.
